...
- `scope`: _optional_, default: `scope=sub`
...
[qlty-img]: https://qlty.sh/gh/haraka/projects/haraka-plugin-ldap/maintainability.svg
[qlty-url]: https://qlty.sh/gh/haraka/projects/haraka-plugin-ldap
